...
/**
 * Request for authorizing payment through connector
 */
@Schema(description = "Request for authorizing payment through connector")
public class ConnectorAuthorizationRequest {
    ...
    @JsonProperty("amount")
    @Schema(description = "Authorization amount")
    private Long amount;
